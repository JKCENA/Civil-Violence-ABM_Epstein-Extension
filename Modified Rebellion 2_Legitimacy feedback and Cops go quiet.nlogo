...
"cops" 1.0 0 -5825686 true "" "plot count cops with [ incentive* - net-risk* > threshold ]"
...
531
557
enforcing cops (purple)
count cops with [ incentive* - net-risk* > threshold]
17
1
11
...
@#$#@#$#@
<experiments>
  <experiment name="Modified Rebellion 1" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>count cops with [quiet?]</metric>
    <metric>count cops with [not quiet?]</metric>
    <metric>mean [risk-aversion*] of cops</metric>
    <metric>mean [perceived-hardship*] of cops</metric>
    <metric>mean [incentive*] of cops</metric>
    <metric>mean [net-risk*] of cops</metric>
    <metric>mean [incentive* - net-risk*] of cops</metric>
    <metric>mean [probability-overwhelmed*] of cops</metric>
    ...
    <metric>government-legitimacy</metric>
  ...
  <experiment name="experiment (copy)" repetitions="3" runMetricsEveryStep="true">
    ...
    <metric>mean [incentive* - net-risk*] of cops</metric>
    <metric>mean [probability-overwhelmed*] of cops</metric>
    <metric>count cops with [quiet?] / count cops with [not quiet?]</metric>
    <metric>count agents with [not active? and jail-term = 0]</metric>
    <metric>count agents with [jail-term &gt; 0]</metric>
    <metric>mean [jail-term] of agents</metric>
    <metric>mean [risk-aversion] of agents</metric>
    ...
    <metric>mean [(perceived-hardship - (1 - government-legitimacy)) - risk-aversion * estimated-arrest-probability] of agents</metric>
    <metric>mean [estimated-arrest-probability] of agents</metric>
    <metric>count agents with [active?] / count agents with [not active? and jail-term = 0]</metric>
    <metric>mean [cop-threshold] of cops</metric>
    <metric>mean [agent-threshold] of agents</metric>
    <metric>government-legitimacy</metric>
    <enumeratedValueSet variable="government-legitimacy">
      <value value="0.82"/>
    </enumeratedValueSet>
