...
globals [
  ...
  total-spread-activation
  total-random-jump-activation
]
...
to setup
  ...
  set k 2.3
  set threshold 0.1
  set total-spread-activation 0
  set total-random-jump-activation 0
  ask patches [
...
to go
  ask turtles [
    ...
    if breed = agents and jail-term = 0 [
      determine-behavior
      if active? [
      spread-activation  ; Spread activation to neighbors if active
      random-jump-activation ; Randomly jump activation to another agent
    ]
    ]
...
to spread-activation
  if neighbors-activation? and random 100 < probability-of-spread [
    ...
    set total-spread-activation total-spread-activation + spread-count
  ]
end
...
@#$#@#$#@
<experiments>
  <experiment name="Rebellion original model" repetitions="50" sequentialRunOrder="false" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>count agents with [active?]</metric>
    <metric>count agents with [not active? and jail-term = 0]</metric>
    <metric>count agents with [jail-term &gt; 0]</metric>
    <metric>mean [jail-term] of agents</metric>
    <metric>mean [risk-aversion] of agents</metric>
    <metric>mean [perceived-hardship] of agents</metric>
    <metric>mean [perceived-hardship - (1 - government-legitimacy)] of agents</metric>
    <metric>mean [risk-aversion * estimated-arrest-probability] of agents</metric>
    <metric>mean [(perceived-hardship - (1 - government-legitimacy)) - risk-aversion * estimated-arrest-probability] of agents</metric>
    <metric>mean [estimated-arrest-probability] of agents</metric>
  ...
  <experiment name="probability of spread" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>count agents with [active?]</metric>
    ...
    <metric>mean [(perceived-hardship * (1 - government-legitimacy)) - (risk-aversion * estimated-arrest-probability)] of agents</metric>
    <metric>mean [estimated-arrest-probability] of agents</metric>
    <metric>total-spread-activation</metric>
    <metric>total-random-jump-activation</metric>
    <enumeratedValueSet variable="government-legitimacy">
      <value value="0.82"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="movement?">
    ...
    <enumeratedValueSet variable="neighbors-activation?">
      <value value="true"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="jump-activation?">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="initial-cop-density">
      <value value="4"/>
  ...
  <experiment name="probability of jump" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>count agents with [active?]</metric>
    ...
    <enumeratedValueSet variable="probability-of-jump">
      <value value="20"/>
      <value value="30"/>
      <value value="40"/>
    </enumeratedValueSet>
  ...
  <experiment name="probability of spread and jump" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>count agents with [active?]</metric>
